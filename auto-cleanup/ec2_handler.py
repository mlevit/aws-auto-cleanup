...
class EC2:
    ...
    def addresses(self):
        ...
        if clean:
            ...
            logging.debug("Skipping cleanup of EC2 Addresses.")
    ...
    def instances(self):
        ...
        if clean:
            ...
            logging.debug("Skipping cleanup of EC2 Instances.")
    ...
    def snapshots(self):
        ...
        if clean:
            ...
            logging.debug("Skipping cleanup of EC2 Snapshots.")
    ...
    def volumes(self):
        ...
        if clean:
            ...
            logging.debug("Skipping cleanup of EC2 Volumes.")